...
if __name__ == '__main__':
    ...
    round2_all = []
    round3_all = {}
    round1 = cheapest_cities(50, '20230429', start, None)
    print(round1)

    lock = threading.RLock()
    with concurrent.futures.ThreadPoolExecutor(max_workers=8) as executor:
        for city_code, price in round1.items():
            executor.submit(parallel_search, 100, '20230501', city_code, None, round2_code_all, round2_all)

    round2_code_all = list(set(round2_code_all))
    for city_code in round2_code_all:
        round3 = cheapest_cities(1, '20230504', city_code, 'CTU')
    ...
    for city_code, round2_item in round2_all:
        ...
        for city_code2, trip2_price in round2_item.items():
            ...
            if trip3_price:
                trip_tuples.append((are_list[start] + "-" + are_list[city_code] + "-" + are_list[city_code2] + "-" +
                                    are_list[end], trip1_price, trip2_price, trip3_price,
